...
ActiveRecord::Schema.define(version: 20200710064808) do
  ...
  create_table "contact_informations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["restaurant_id"], name: "index_contact_informations_on_restaurant_id", using: :btree
  end
  ...
  add_foreign_key "contact_informations", "restaurants"
